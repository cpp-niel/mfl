...
namespace mfl
{
    TEST_SUITE("left_right noad")
    {
        ...
        TEST_CASE("becomes a content box with a delimiter glyph on either side")
        {
        ...
        TEST_CASE("becomes a content box with a delimiter glyph on right side when left delimiter is zero")
        {
            const auto result = left_right_to_hlist(
        ...
        TEST_CASE("becomes a content box with a delimiter glyph on left side when right delimiter is zero")
        {
            const auto result = left_right_to_hlist(
