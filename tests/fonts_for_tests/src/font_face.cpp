...
namespace mfl::fft
{
    ...
    math_constants font_face::constants() const
    {
        ...
        return {get_constant(HB_OT_MATH_CONSTANT_AXIS_HEIGHT),
                get_constant(HB_OT_MATH_CONSTANT_SUBSCRIPT_BASELINE_DROP_MIN),
                get_constant(HB_OT_MATH_CONSTANT_SUBSCRIPT_SHIFT_DOWN),
                get_constant(HB_OT_MATH_CONSTANT_SUPERSCRIPT_BASELINE_DROP_MAX),
                get_constant(HB_OT_MATH_CONSTANT_SUPERSCRIPT_SHIFT_UP),
                get_constant(HB_OT_MATH_CONSTANT_SUPERSCRIPT_SHIFT_UP_CRAMPED),
                get_constant(HB_OT_MATH_CONSTANT_SUB_SUPERSCRIPT_GAP_MIN),
                get_constant(HB_OT_MATH_CONSTANT_SUPERSCRIPT_BOTTOM_MAX_WITH_SUBSCRIPT),
                get_constant(HB_OT_MATH_CONSTANT_SPACE_AFTER_SCRIPT),
                get_constant(HB_OT_MATH_CONSTANT_RADICAL_VERTICAL_GAP),
                get_constant(HB_OT_MATH_CONSTANT_RADICAL_RULE_THICKNESS),
                get_constant(HB_OT_MATH_CONSTANT_RADICAL_EXTRA_ASCENDER),
                get_constant(HB_OT_MATH_CONSTANT_RADICAL_KERN_BEFORE_DEGREE),
                get_constant(HB_OT_MATH_CONSTANT_RADICAL_KERN_AFTER_DEGREE),
                hb_ot_math_get_constant(hb_font.get(), HB_OT_MATH_CONSTANT_RADICAL_DEGREE_BOTTOM_RAISE_PERCENT),
                default_fraction_params,
                display_style_fraction_params,
                default_atop_params,
                display_style_atop_params};
    }
